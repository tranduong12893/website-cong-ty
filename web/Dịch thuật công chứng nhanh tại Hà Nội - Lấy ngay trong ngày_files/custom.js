...
jQuery(window).scroll(function () {
	if (jQuery(this).scrollTop() >0) {
		...
		jQuery('.header').removeClass('fixed_header').removeClass('swingOutX').removeClass('swingInX');
	}
});
jQuery(function(){
...
jQuery(window).on('mousewheel DOMMouseScroll', function(e){
  if(typeof e.originalEvent.detail == 'number' && e.originalEvent.detail !== 0) {
    if(e.originalEvent.detail > 0) {
      jQuery('.header').removeClass('swingOutX').addClass('swingInX').addClass('no_top');
    } else if(e.originalEvent.detail < 0){
        jQuery('.header').removeClass('swingInX').addClass('swingOutX');
    }
